...
<html>
  ...
  <body>
      ...
      <ul class="nav nav-pills">
        ...
        <li>
          <form class="form-inline" action="../php/buscarlibros.php" method="post">
            <input class="form-control mr-sm-2" type="search" name="numero" placeholder="Ingrese folio" aria-label="Search" required>
    ...
    <table>
        ...
        <?php $busqueda = mysqli_query($conn, "SELECT * FROM libros");
